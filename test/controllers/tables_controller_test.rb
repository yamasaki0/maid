...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { name: @table.name, qty: @table.qty, seat: @table.seat, status: @table.status } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { name: @table.name, qty: @table.qty, seat: @table.seat, status: @table.status } }
